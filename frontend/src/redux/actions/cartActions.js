...
//adding to cart
export const addItemsToCart=(foodItemId,restaurantId,quantity)=>async(dispatch,getState)=>{
    try{
        dispatch(cartRequest());
...
//remove from cart
export const removeItemFromCart=(foodItemId,quantity)=>async(dispatch,getState)=>{
    try{
        const {user} = getState().user;
